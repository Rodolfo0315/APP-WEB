...
?>
 ...
 where r.estado_reparacion='reparado' and r.fecha_estimada='$fecha' ")or die(mysqli_error($con));
    $contador=0;
...
?>
  ...
  <a class="btn btn-danger btn-print"    disabled="true" style="height:25%; width:50%; font-size: 25px " role="button">CANTIDAD DE ELEMENTOS= <label style='color:black;  font-size: 25px '>=<?php echo $contador;?></label></a><br>
