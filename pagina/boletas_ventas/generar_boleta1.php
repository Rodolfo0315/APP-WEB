  ...
  $content .= '
    <tr  bgcolor="'.$color.' ">
            <td>Fecha estimada:   '.$fecha_estimada.'</td>  
              ...
              <tr  bgcolor="'.$color.' ">
            <td>Placa:   '.$placa.'</td>  
          <td>Fallas:    '.$diagnóstico_automotriz.'</td> 
 
                    </tr>
                                 <tr  bgcolor="'.$color.' ">
            <td>Cliente:   '.$nombre_cliente.'</td>  
    <td>Precio estimado reparacion:   '.$costo_de_chequeo.'</td>  
...
<td style="border:none;"></td> 
                ...
                <td style="border:none;"></td> 
                     <td style="border:none;">sub total repuestos= '.$sub.'<br>sub total reparacion= '.$costo_de_chequeo.'<br> impuesto= '.$igv.'<br> total= '.$sum.'<br> 
                <td style="border:none; "></td> 
              </tr>
                 <tr style="border:none; ">
                      <tr style="border:none;  ">
